...
const MyProfile = (props) => {
  ...
  const id = localStorage.getItem("donorname");
...
/////////THIS WILL SUBMIT THE DATA
  ...
  ////////////////retrieve current donor data/////////////////////{}
  useEffect(() => {
    getCurrentPerson();
  }, []);
  const getCurrentPerson = () => {
    bookingServices
      .getDonorPersondata(id)
            ...
            />
             ...
             <Grid  item  xs={12} md={12}>
               ...
               variant="filled"
                 name="national_id"
                 label="NIC"
                 value={values.national_id = item.national_id}
                 onChange={handleInputChange}
             ...
             variant="filled"
                 name="donor_name"
                 label="Name"
                 value={values.donor_name = item.donor_name}
                 onChange={handleInputChange}
            ...
            <Grid>
             ...
             <Input
               ...
               variant="filled"
                 ...
                 label="Contact"
                maxLength={10}
                 value={values.contact_no = item.contact_no}
                 onChange={handleInputChange}
             ...
             <Grid item  xs={12} md={12}>
               ...
               type="password"
                 label="Password"
                 name="donor_password"
                 value={values.donor_password = item.donor_password}
                 onChange={handleInputChange}
