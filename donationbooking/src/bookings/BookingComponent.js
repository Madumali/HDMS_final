...
import Print from "./pages/printletter/Print";
...
<div style={{marginLeft:1150,marginTop:35}}>
  <MyBreadcrumb />
  </div>
    <Switch>
            ...
            <Route exact path='/bookings/mainpage/mybookings/print' component={(props)=><Protected2 Cmp ={Print}{...props}/>} />
            <Route exact path='/myprofile' component={(props)=><Protected2 Cmp ={MyProfile}{...props}/>} />
